...
print 'Calibrando a ventoinha do Dractor...'
MissionPlanner.MainV2.speechEngine.SpeakAsync("Calibrando a Ventoinha do Dractor 25A")
...
# MAX PWM
MAV.doCommand(MAVLink.MAV_CMD.DO_SET_SERVO, PWM_FAN_CHANNEL,PWM_FAN_MAX, 0,0,0,0,0)
time.sleep(8)
MAV.doCommand(MAVLink.MAV_CMD.DO_SET_SERVO, PWM_FAN_CHANNEL,PWM_FAN_MIN, 0,0,0,0,0)
# Turn on FAN
# turnON_fan(8.0,0.2)

print 'Pronto! Ventoinha Calibrada'
MissionPlanner.MainV2.speechEngine.SpeakAsync("Ventoinha Calibrada")
